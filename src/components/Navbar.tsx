      ...
      <header className="sticky w-full top-0 left-0 z-50 py-4 backdrop-blur-[0.7px]">
        <div className="nav-container container px-6 mx-auto">
          <nav className="flex justify-between">
            ...
            >
              <button
                className="absolute top-9 right-8 md:hidden rounded-full border border-gray-700 flex justify-center items-center p-1 h-[36px] w-[36px] hover:border-[#00CC75] hover:rotate-180 transition-translate ease-in-out duration-300 cursor-pointer"
                onClick={() => setOpenNav(false)}
              >
                <X size={36} />
              </button>
              <ul className="nav-list flex flex-col md:flex-row items-center justify-center gap-6 w-1/2">
                <li className="capitalize active">
              ...
              <div className="theme flex flex-col md:flex-row items-center gap-4">
                ...
                <button
                  className={`theme-button rounded-full border border-gray-900 flex justify-center items-center p-2 h-[36px] w-[36px] md:h-[40px] md:w-[40px] hover:border-[#00CC75] hover:rotate-180 transition-transform ease-in-out duration-300 cursor-pointer`}
            ...
            <div className="hamburger flex items-center md:hidden text-white">
              ...
              >
                ...
                >
                  ...
                  />
                  <path
                    d="M0 0 C3.96 0 7.92 0 12 0 C12 0.66 12 1.32 12 2 C8.04 2 4.08 2 0 2 C0 1.34 0 0.68 0 0 Z "
                    fill={theme === "dark" ? "#fff" : "#000"}
