...
export default function Skills() {
  return (
    <section
      id="#skills"
      className="skill-section bg-[#0f0f0f] border-t border-b border-[#2a2a2a] py-6 md:py-32 px-6 md:px-16"
    >
      <div className="container mx-auto">
        <div className="skill-container flex flex-col items-center justify-center">
          <h3 className="skills-stacks text-[60px] pb-10 tracking-tight font-extralight md:self-start text-center">
            Skills & Stacks
          </h3>
...
function SkillCard({ path, name }: SkillCardProps) {
  return (
    <motion.div
      className="skill-card border border-[#2a2a2a] flex flex-col items-center justify-center gap-4 size-40 hover:border-[#00CC75] hover:bg-[rgba(0,255,148,0.03)] group transition-color ease duration-300"
      initial="hidden"
      whileInView="visible"
      viewport={{ once: true }}
      variants={{
