  ...
  return (
    <section id="home" className="h-[90vsh] hero overflow-hidden">
      <div className="container mx-auto px-6">
        ...
        >
          <h1 className="hero self-start text-[clamp(3.5rem,10vw,8rem)] tracking-none leading-[0.9] mb-[40px] font-extralight">Crafting digital<br />experiences with<br /><span className="quote font-thin">code & design.</span>
          </h1>
          ...
          <div className="buttons flex flex-col sm:flex-row self-start gap-3 w-full">
            <button id="project" className="view-project bg-[#00cc75] sm: px-4 py-3 border border-[#00cc75] text-[14px] cursor-pointer hover:shadow-[0_0_26px_3px] shadow-[#00CC75]/40 hover:-translate-y-0.5 transition-all ease-in-out duration-100">View Projects</button>
